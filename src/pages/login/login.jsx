        ...
        <View>
            ...
            <View style={style.container}>
                <View style={style.textContainer}>
                    <Image source={require('../../../assets/LogoDarkOutCircle.png')} style={style.image} />
                    <Title className={['text-white', 'text-center', 'extra-bold', 'text-4xl']} style={{ marginBottom: 15 }}>Art Book</Title>
                    <PrimaryText className={['text-white', 'text-center', 'mb-30']}>
